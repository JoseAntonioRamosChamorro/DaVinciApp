...
public class EsculturaFragment extends Fragment {
    ...
    private EsculturaViewModel galleryViewModel;

    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState) {
        galleryViewModel =
                new ViewModelProvider(this).get(EsculturaViewModel.class);
        View root = inflater.inflate(R.layout.escultura, container, false);
        final TextView textView = root.findViewById(R.id.txvirgen);
